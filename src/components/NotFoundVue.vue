<script setup>
import DashbordLayout from '@/layout/DashbordLayout.vue';

</script>
<template>
    <div v-if="$route.path.startsWith('/admin/')">
        <div class="mx-auto max-w-screen-sm text-center p-32">
            <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-primary-600 dark:text-primary-500">
                404</h1>
            <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Adminstrator Error</p>
            <b>Page not found</b>
        </div>
    </div>
